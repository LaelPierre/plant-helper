...
ActiveRecord::Schema.define(version: 2022_03_01_223042) do
  ...
  create_table "user_tasks", force: :cascade do |t|
    ...
    t.index ["user_plant_id"], name: "index_user_tasks_on_user_plant_id"
  end
  ...
  add_foreign_key "user_tasks", "user_plants"
end
